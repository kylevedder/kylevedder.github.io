...
function loadPLYAndFlow(frameIndex) {
    const plyFileName = `img/static/gigachad/raw_data/av2_bird/${padNumber(frameIndex)}.ply`;
    const jsonFileName = `img/static/gigachad/raw_data/av2_bird/${padNumber(frameIndex)}.json`;
